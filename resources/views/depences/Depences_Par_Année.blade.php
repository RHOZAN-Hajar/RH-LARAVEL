...
<br>
                ...
                <a href="/marquer_depences"  class="btn btn-success enregistrer btn-primary "    style="background-color: #726AB4;" >Nouvelle Depence</a>
        

   


<h3 style="color: white"   class="text-center">Depences par année :</h3>
    ...
    <tbody>
        @foreach ($salaries as $salarie)
              <tr>
                ...
                <td><a class="btn btn-info btn_sm" style="background-color: #726AB4;"  href="{{Route('depences_par_mois',$salarie->id_salarie) }}"> <span style="color:black"><i class="fa fa-folder-open" aria-hidden="true">Details<span class="spinner-grow spinner-grow-sm"></span></i></span> </a></td>
            </tr>
        @endforeach
...
<style>
    ...
    background-size: cover; /* Assurez-vous que l'image de fond couvre toute la zone */
