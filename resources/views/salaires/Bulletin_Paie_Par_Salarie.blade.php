...
<div class="row">
    ...
    <div class="col-12">
        ...
        <a class="dropdown-item" href="{{ route('telecharger_bulletin_paie', ['id_salarie' => $salarie->id_salarie]) }}">Télécharger le bulletin </a>
...
<table class="table" style="background: rgb(223, 223, 223)">
    ...
    <tbody>
            <tr>
                <td class="info">{{$salarie->salaire_initial}}</td>
